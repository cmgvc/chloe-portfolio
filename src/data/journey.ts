...
const journey: Journey[] = [
    {
        ...
        description: [
            "Radio software development. At Dell, I produce and maintain software for the company's radio products, which are used in wireless communication systems. This involves designing, coding, testing, and debugging software components, including drivers and services, that control the operation of radio hardware.",
            "I collaborate with cross-functional teams to ensure that our software meets performance and reliability standards, and I stay up-to-date with industry trends to incorporate new technologies into our products."
        ],
    },
    {
        id: "mbc-2024",
    ...
    },
    {
        ...
        subtitle: "B.Sc. in Software Engineering and Anatomy & Cell Biology",
